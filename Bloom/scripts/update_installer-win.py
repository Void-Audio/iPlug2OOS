...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Bloom Demo Installer\n"
      else:
        line="OutputBaseFilename=Bloom Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Bloom Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Bloom installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Bloom Demo installer\n"
     else:
       line="SetupWindowTitle=Bloom installer\n"
