...
NOTARIZE_BUNDLE_ID=com.AcmeInc.Bloom
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.Bloom.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Bloom.iss
#  git checkout installer/Bloom.pkgproj
