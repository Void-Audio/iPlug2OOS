...
#define AUV2_ENTRY Bloom_Entry
#define AUV2_ENTRY_STR "Bloom_Entry"
#define AUV2_FACTORY Bloom_Factory
#define AUV2_VIEW_CLASS Bloom_View
#define AUV2_VIEW_CLASS_STR "Bloom_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "Bloom\nIPEF"
