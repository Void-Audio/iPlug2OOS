...
#define AUV2_ENTRY Rend_Entry
#define AUV2_ENTRY_STR "Rend_Entry"
#define AUV2_FACTORY Rend_Factory
#define AUV2_VIEW_CLASS Rend_View
#define AUV2_VIEW_CLASS_STR "Rend_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "Rend\nIPEF"
