...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Rend Demo Installer\n"
      else:
        line="OutputBaseFilename=Rend Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Rend Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Rend installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Rend Demo installer\n"
     else:
       line="SetupWindowTitle=Rend installer\n"
