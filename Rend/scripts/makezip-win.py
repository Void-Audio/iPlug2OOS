...
def main():
  ...
  if not zip:
    installer = "\\build-win\\installer\\Rend Installer.exe"
    
    if demo:
      installer = "\\build-win\\installer\\Rend Demo Installer.exe"
    
    files = [
      projectpath + installer,
      projectpath + "\\installer\\changelog.txt",
      projectpath + "\\installer\\known-issues.txt",
      projectpath + "\\manual\\Rend manual.pdf" 
    ]
  else:
    files = [
      projectpath + "\\build-win\\Rend.vst3\\Contents\\x86_64-win\\Rend.vst3",
      projectpath + "\\build-win\\Rend_x64.exe",
      projectpath + "\\build-win\\Rend.clap"
    ]
  ...
  files = [
    projectpath + "\\build-win\\pdbs\\Rend-vst3_x64.pdb",
    projectpath + "\\build-win\\pdbs\\Rend-app_x64.pdb",
    projectpath + "\\build-win\\pdbs\\Rend-clap_x64.pdb"
  ]
