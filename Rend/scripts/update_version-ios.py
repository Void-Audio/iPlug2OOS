...
# AUDIOUNIT v3
  ...
  with open(plistpath, 'rb') as f:
    ...
    if config['PLUG_HAS_UI'] == 1:
      ...
      auv3['NSExtension']['NSExtensionAttributes']['AudioComponents'][0]['factoryFunction'] = "IPlugAUViewController_vRend"
      auv3['NSExtension']['NSExtensionMainStoryboard'] = config['BUNDLE_NAME'] + "-iOS-MainInterface"
    else:
      auv3['NSExtension']['NSExtensionPrincipalClass'] = "IPlugAUViewController_vRend"
